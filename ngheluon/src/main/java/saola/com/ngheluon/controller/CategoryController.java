...
@RestController(value = "categorys")
...
public class CategoryController {
  ...
  @GetMapping()
  public List<Category> findAll(@Nullable Pageable pageble) {
  ...
  @PostMapping()
  public ResponseEntity<Category> add(@Valid @RequestBody Category entity) {
